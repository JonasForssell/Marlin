...
inline void gcode_M502() {
  ...
  inline void gcode_M906() {
    ...
    // Assumes {A_AXIS, B_AXIS, C_AXIS} == {X_AXIS, Y_AXIS, Z_AXIS}
    ...
    #endif
    #if ENABLED(HANGPRINTER)
      // If N extruders, then D-motor connected to EN motor output.
      #if E0_IS_TRINAMIC
      ...
      #endif
      // Set D-current on EN motor output.
      #if E1_IS_TRINAMIC && EXTRUDERS == 1
        TMC_SET_GET_CURRENT(D,E1);
      #endif
      #if E2_IS_TRINAMIC && EXTRUDERS == 2
        TMC_SET_GET_CURRENT(D,E2);
      #endif
      #if E3_IS_TRINAMIC && EXTRUDERS == 3
        TMC_SET_GET_CURRENT(D,E3);
      #endif
      #if E4_IS_TRINAMIC && EXTRUDERS == 4
        TMC_SET_GET_CURRENT(D,E4);
      #endif
    #else
      #if E0_IS_TRINAMIC
        TMC_SET_GET_CURRENT(E,E0);
